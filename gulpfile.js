...
//         .pipe( conn.newer( '/htdocs/dorfverein/wp-content/themes/dorfscheune/' ) ) // only upload newer files
//         .pipe( conn.dest( '/htdocs/dorfverein/wp-content/themes/dorfscheune/' ) )
...
gulp.task('deploy-dev', function() {
    ...
    return gulp.src( globs, { base: '.', buffer: false } )
        ...
        .pipe(gulp.dest( '/htdocs/dorfverein/wp-content/themes/dorfscheune/' ) )
        .pipe(conn)
        //.pipe(notify("Dev site updated!"));
});
